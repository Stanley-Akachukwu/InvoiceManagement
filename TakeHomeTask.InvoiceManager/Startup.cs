...
using TakeHomeTask.InvoiceManager.Data.Concrete;
using TakeHomeTask.InvoiceManager.Services.Concrete;

namespace TakeHomeTask.InvoiceManager
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                client.BaseAddress = new Uri("http://localhost:54433/");
            });
